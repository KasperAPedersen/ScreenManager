...
_ = new Box(cWidth - 3, cHeight - 2, 0, 0);
_ = new Box(cWidth - 5, cHeight - 4, 1, 1);
...
while(bKeepRunning)
{
    ...
    switch (Console.ReadKey().Key)
    {
        ...
        case ConsoleKey.C:
            ...
            Box tt1 = new(50, 21, cWidth / 2 - 25, cHeight / 2 - 10);
            for(int i = 0; i < 5; i++)
            {
                _ = new Box(25, 4, tt1.GetLeft + tt1.GetWidth - 26, cHeight / 2 - 9 + (i*3));
